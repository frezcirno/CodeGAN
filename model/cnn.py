...
class CNNClassifier(nn.Module):
    def __init__(
        ...
        self.src_embedding = nn.Embedding(vocab_size, hidden_size, tokenizer.pad_token_id)
        self.tgt_embedding = nn.Embedding(vocab_size, hidden_size, tokenizer.pad_token_id)
